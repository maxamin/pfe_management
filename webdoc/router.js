export class DatabaseFileManagerClient {
    constructor() {
    ...
    createFile(filename, content, directory, userId, callback) {
        const data = { filename, content, directory, userId };
    ...
    exportDirectory(directory, targetPath, ownerid, callback) {
        const data = { directory, targetPath, ownerid };
